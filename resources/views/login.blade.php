...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" media="screen, print" href="{{ asset('asset/css/fa-brands.css') }}">
    </head>
    <!-- BEGIN Body -->
    <!-- Possible Classes
                ...
                <div class="page-content-wrapper bg-transparent m-0">
                    <!-- <div class="height-10 w-100 shadow-lg px-4 bg-brand-gradient">
                        <div class="d-flex align-items-center container p-0">
                            <div style="width:83.875rem !important" class="page-logo width-mobile-auto m-0 align-items-center justify-content-center p-0 bg-transparent bg-img-none shadow-0 height-9 border-0">
                                <a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex align-items-center">
                                    <img src="{{ asset('asset/img/logo-pemkab.png') }}" style="width:60px; height:50px"  alt="SmartAdmin WebApp" aria-roledescription="logo">
                                    <span class="page-logo-text mr-1">Pemerintahan Kabupaten Gresik Dinas Pendidikan <br><small>Jl Arif rahmat Hakim No 22 Gresik.Telp. 031-3981315 </small></span>
                                </a>
                            </div>
                        </div>
                    </div> -->
...
@csrf
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="npsn" id="username" class="form-control form-control-lg" placeholder="Username" required>
                                                <!-- <div class="invalid-feedback">No, you missed this one.</div> -->
                                                <div class="help-block">Your Usename</div>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="position-absolute pos-bottom pos-left pos-right p-3 text-center text-white">
                                2022 © Bagian Tenaga Kependidikan - Dinas pendidikan Kabupaten Gresik
                            </div>
                        </div>
                    </div>
                </div>
